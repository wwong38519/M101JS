...
function ItemDAO(database) {
    ...
    this.getItem = function(itemId, callback) {
        ...
        this.db.collection('item').findOne({_id: itemId}).then(function(item){
            callback(item);
        })
    }
    ...
    this.addReview = function(itemId, comment, name, stars, callback) {
        ...
        this.db.collection('item').findOneAndUpdate({_id: itemId}, {'$push': {reviews: reviewDoc}}).then(function(doc){
            callback(doc);
        });
    }
