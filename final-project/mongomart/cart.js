...
function CartDAO(database) {
    ...
    this.getCart = function(userId, callback) {
        ...
        */
        ...
        this.db.collection('cart').findOne({userId: userId}).then(function(userCart){
            callback(userCart);
        });
    }
    ...
    this.updateQuantity = function(userId, itemId, quantity, callback) {
        ...
        */
        ...
        this.db.collection('cart').findOneAndUpdate(query, update, {returnOriginal: false}, function(err, result){
            assert.equal(null, err);
            callback(result.value);
        });
    }
